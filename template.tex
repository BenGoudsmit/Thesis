...
$if(thesis_url)$
An online version of this thesis is available at $thesis_url$$if(license)$, 
licensed under a $license$.$endif$

$endif$

$if(grant)$
Financial support for the publication of this thesis was kindly provided by $if(grant)$ $grant$.$endif$
$endif$
\endgroup
...
te verdedigen op $if(date)$$date$$else$[………]dag […date…] […month…] 20[..]$endif$\\ 
klokke $if(time)$$time$$else$[…time…]$endif$ uur \\ }\par %
