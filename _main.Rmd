...
In **Chapter \@ref(chap-disc)**, this thesis will be summarized, discussed, and provided with future perspectives. In **Chapter \@ref(chap-nlsum)**, a Dutch summary is given.
...
knitr::include_graphics("figures/figure-html/meldna-fig1-1.png")
```
...
knitr::include_graphics("figures/figure-html/meldna-fig2-1.png")
```
...
knitr::include_graphics("figures/figure-html/meldna-fig3-1.png")
```
...
knitr::include_graphics("figures/figure-html/meldna-fig4-1.png")
```
...
knitr::include_graphics("figures/figure-html/meldna-fig5-1.png")
...
knitr::include_graphics("figures/figure-html/meldna-fig6-1.png")
```
...
knitr::include_graphics(c("figures/figure-html/meldna-fig7-1.png",
                          "figures/figure-html/meldna-fig7-2.png"))
```
...
knitr::include_graphics(c("figures/figure-html/meldna-fig8-1.png"))
```
...
<!--chapter:end:02-chapter-meldna.Rmd-->
...
knitr::include_graphics(c("figures/figure-html/refit-fig1-1.png",
                          "figures/figure-html/refit-fig1-2.png",
                          "figures/figure-html/refit-fig1-3.png"))
```
...
knitr::include_graphics(c("figures/figure-html/refit-fig2-1.png",
                          "figures/figure-html/refit-fig2-2.png",
                          "figures/figure-html/refit-fig2-3.png"))
```
...
options(knitr.kable.NA = '')
kbl(tab2, booktabs=T, caption = "Number of patient measurements included in UNOS and refit models",
    linesep= "")%>%
  kable_styling(latex_options = c("scale_down","striped")) %>%
  kable_classic() %>%
  # pack_rows("Creatinine", 1, 2) %>% pack_rows("Bilirubin", 3, 4) %>% pack_rows("INR", 5, 6) %>%
  # pack_rows("Sodium", 7, 8) %>%
  # kable_styling(latex_options = c("scale_down")) %>% 
  #column_spec(1:8, width = "5em") %>%   
  footnote(threeparttable=T, general= "For each parameter the lower and upper bounds are shown. 'Patients capped' shows the percentage of the cohort that either lies under or above the chosen bounds. 'Patients included' shows the percentage of patients whose measurements are included in the model.") 
...
kbl(tab4, booktabs=T, caption = "Characteristics of Prioritized Patients",
  ...
  pack_rows("Serum measurement at listing (mean (SD))", 18, 21) %>%
landscape()

options(warn=0)
``` 
Most notably, reMELD-Na-prioritized patients were slightly older, were more often male, and had a higher prevalence of cirrhosis. Unsurprisingly, these patients had significantly lower serum sodium levels (138 vs. 127 mmol/L). As hyponatremia is most often seen in alcohol-associated cirrhosis,^14^ the sex and age differences are largely explained.
...
knitr::include_graphics("figures/figure-html/refit-fig4-1.png")
```
...
<!--chapter:end:03-chapter-refit.Rmd-->
...
knitr::include_graphics(c("figures/figure-html/jm-fig1-1.png"))
```
...
knitr::include_graphics("figures/figure-html/aclf-fig2-1.png")
```
...
<!--chapter:end:07-chapter-jm-aclf.Rmd-->
...
knitr::include_graphics(c("figures/figure-html/benefit-fig1a-1.png"))
```
...
knitr::include_graphics(c("figures/figure-html/benefit-fig1b-1.png"))
```
...
options(knitr.kable.NA = '')
kbl(tab1, longtable = T, booktabs=T, 
  ...
  footnote(threeparttable=T, 
           ...
           general = "HCC: hepatocellular carcinoma, AFP: alpha-fetoprotein"
           ) %>% 
  landscape()
...
knitr::include_graphics(c("figures/figure-html/benefit-fig2-1.png"))
```

Figure \@ref(fig:benefit-fig3a) shows the smoothed average survival probabilities during the next five years, both for post-transplantation (with LT: solid lines) and for remaining on the waiting list (without LT: dashed lines). Because life years are gained over time, Figure \@ref(fig:benefit-fig3a) shows the mean survival during five years, i.e., the mean of the lines shown in Figure \@ref(fig:benefit-fig1b). The survival probabilities at five years without and with LT are presented in Table S3, which are perhaps more intuitive survival measures for the clinician and patient. However, these hold no information regarding the survival trajectory during five years, which is what the average survival and benefit do encompass. 
...
```{r benefit-fig3a, echo=F, message=F, fig.cap='The mean survival during the next five years per MELD(-Na) score, for the waiting list (dashed lines) and after transplantation (solid lines). Note that the dashed lines represent future ‘without LT’ waiting list survival. The left y-axis shows life expectancy in years, the right y-axis shows survival probability.'}
knitr::include_graphics(c("figures/figure-html/benefit-fig3a-1.png"))
```

### Survival benefit: life-years gained per 5 years {.unnumbered}
The 5-year transplantation survival benefit per MELD(-Na) score and per (non-)HCC disease is shown in Figure \@ref(fig:benefit-fig3b) and Table \@ref(tab:benefit-tab2) (see Table S4 for the averages per MELD(-Na) score). Please note that the y-values correspond to the surface area shown in Figure \@ref(fig:benefit-fig1b), e.g., for a non-HCC MELD(-Na) 25 patient, LT would give 2.35 years survival benefit during the next five years. 
...
<!--chapter:end:08-chapter-benefit.Rmd-->
...
knitr::include_graphics(c("figures/figure-html/disc-fig1-1.png"), auto_pdf=T)
```
...
knitr::include_graphics(c("figures/figure-html/disc-fig3-1.png"), auto_pdf=T)
```
...
\noindent  *Goudsmit BFJ, Putter H, van Hoek B. The Model for End-stage Liver Disease 3.0: an update without proven accuracy. Gastroenterology, 2021; doi: [10.1053/j.gastro.2021.09.047](https://doi.org/10.1053/j.gastro.2021.09047). \*
...
\noindent *Goudsmit BFJ, Tushuizen ME, Putter H, Braat AE, van Hoek B. The role of the model for end-stage liver disease-sodium score and joint models for 90-day mortality prediction in patients with acute-on-chronic liver failure. J Hepatol. 2021;74(2):475-476. doi: [10.1016/j.jhep.2020.08.032](https://www.journal-of-hepatology.eu/article/S0168-8278(20)33606-0/fulltext).* 
...
_Overleving in levertransplantatie_
...
<!--chapter:end:12-summary-Dutch.Rmd-->
...
<!--chapter:end:13-acknowledgments.Rmd-->
...
<!--chapter:end:14-miscellaneous.Rmd-->
