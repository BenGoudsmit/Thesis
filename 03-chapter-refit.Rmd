...
dfcreat %>% ggplot(aes(exp(x),exp(y_centered)))+
  ...
  geom_line(aes(x = exp(x), y = exp((y - 1.96 * se - center))), linetype = 2)+
  scale_x_continuous("Serum creatinine (mmol/L)", limits=c(0.4,6), trans='log10')+
...
dfbili %>% ggplot(aes(exp(x),exp(y_centered)))+
  ...
  geom_line(aes(x = exp(x), y = exp((y + 1.96 * se - center))), linetype = 2)+
  geom_line(aes(x = exp(x), y = exp((y - 1.96 * se - center))), linetype = 2)+
  scale_x_continuous("Serum bilirubin (mmol/L)", limits=c(0.4,100), breaks = c(0.5,1,3,5,10,20,50,100), trans='log10')+
...
tmpbili %>% ggplot(aes(bili1,HR))+
  ...
  scale_x_continuous("Serum bilirubin (mmol/L)", limits=c(0.3,100), trans='log10')+
...
tmpcreat %>% ggplot(aes(creat1,HR))+
  ...
  scale_x_continuous("Serum creatinine (mmol/L)", limits=c(0.4,10), trans='log10')+ # , trans='log10'
...
tmpbili %>% ggplot(aes(bili1,HR))+
  ...
  geom_line(aes(x = bili1, y = HRlow95), linetype = 2)+
  geom_line(aes(x = bili1, y = HRupp95), linetype = 2)+
  scale_x_continuous("Serum bilirubin (mmol/L)", limits=c(0.2,100), trans='log10')+ # , trans='log10'
